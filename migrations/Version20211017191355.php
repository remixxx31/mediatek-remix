 ...
 */
final class Version20211017191355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD kindbook_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A3317E4E17A2 FOREIGN KEY (kindbook_id) REFERENCES kind (id)');
